...
Partial Public Class Player : Inherits Panel
    Public Event DestinationChanged(ByVal sender As Object)
    Public Event MousDestinationChanged(ByVal sender As Object)
 ...
 <DisplayName("Maxnum")> _
    Public Property Maxnumber() As Integer
        ...
        End Set
    End Property
    Public StringStatus As String = "IDLE"
    <PropertyTab("Status")> _
...
#Region "ThemeDraggable"
    ...
    Protected Overrides Sub OnMouseDown(e As MouseEventArgs)
        ...
        'Environment.[Exit](0)
        '  End If
        Dim rect = New Rectangle(Me.Width / 2 - 40, Me.Height / 2, 40, 40)
        ...
        End If
        rect = New Rectangle(Me.Width / 2 + 26, Me.Height / 2, 40, 40)
        If rect.Contains(e.Location) Then
            RaiseEvent FastForward(Me)
            MyBase.OnMouseDown(e)
        End If
        rect = New Rectangle(Me.Width / 2 - 83, Me.Height / 2, 40, 40)
        If rect.Contains(e.Location) Then
    ...
    Protected Overrides Sub OnMouseMove(e As MouseEventArgs)
        ...
        If ((e.Button = MouseButtons.Left) And rectangle.Contains(Me.pointdown)) Then
            ...
            'If (Not volumeChangedEvent Is Nothing) Then
            '    RaiseEvent MousDestinationChanged(Me)
            'End If
        End If
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        e.Graphics.DrawString(StringStatus, New Font("Arial", 8, FontStyle.Regular), New SolidBrush(Color.FromArgb(255, 255, 255)), New Rectangle(5, Me.Height / 2 + 5, 300, 30))
        'Slider
        'e.Graphics.SmoothingMode = SmoothingMode.HighQuality
        ...
        e.Graphics.DrawString("7", New Font("Webdings", 32, FontStyle.Regular), New SolidBrush(Color.FromArgb(255, 255, 255)), New Rectangle(Me.Width / 2 - 90, Me.Height / 2, 40, 40))
        e.Graphics.DrawString("8", New Font("Webdings", 32, FontStyle.Regular), New SolidBrush(Color.FromArgb(255, 255, 255)), New Rectangle(Me.Width / 2 + 16, Me.Height / 2, 50, 40))
        If PlayState2 = True Then
            e.Graphics.DrawString(";", New Font("Webdings", 32, FontStyle.Regular), New SolidBrush(Color.FromArgb(255, 255, 255)), New Rectangle(Me.Width / 2 - 40, Me.Height / 2, 40, 40))
            MyBase.OnPaint(e)
        Else
            e.Graphics.DrawString("4", New Font("Webdings", 32, FontStyle.Regular), New SolidBrush(Color.FromArgb(255, 255, 255)), New Rectangle(Me.Width / 2 - 40, Me.Height / 2, 40, 40))
            MyBase.OnPaint(e)
        End If
    End Sub
    ...
    Public PlayState As Boolean = True
